    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCaches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url_Buy = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    SystemAverageRating = table.Column<double>(type: "double precision", nullable: true),
                    SystemRatingsCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BookId = table.Column<string>(type: "character varying(50)", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCaches_BookId",
                table: "BookCaches",
                column: "BookId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookCaches_CachedAt",
                table: "BookCaches",
                column: "CachedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Books_CachedAt",
                table: "Books",
                column: "CachedAt");
