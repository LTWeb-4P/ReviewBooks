  ...
  "node_modules/typewriter-effect/dist/react.js"(exports, module) {
    !function(e, t) {
      ...
      var t = { 2: (e2, t2, r2) => {
        ...
        var n2 = r2(7534), o2 = r2(346), a = Object.prototype, i = a.hasOwnProperty, s = a.propertyIsEnumerable, u = n2(function() {
          return arguments;
        }()) ? n2 : function(e3) {
        ...
        for (var n2 = r2(3491), o2 = "undefined" == typeof window ? r2.g : window, a = ["moz", "webkit"], i = "AnimationFrame", s = o2["request" + i], u = o2["cancel" + i] || o2["cancelRequest" + i], c = 0; !s && c < a.length; c++)
        ...
        function j(e3, t3) {
          ...
          for (var r3 = 0, n3 = Array(t3); r3 < t3; r3++)
            n3[r3] = e3[r3];
          return n3;
        }
        function E(e3, t3) {
      ...
      return (() => {
        ...
        var d = function(e3) {
          ...
          function d2() {
            ...
            for (var o3 = arguments.length, i2 = new Array(o3), s2 = 0; s2 < o3; s2++)
              i2[s2] = arguments[s2];
